            ...
            <div className="w-full max-w-sm sm:max-w-md p-6 sm:p-8 space-y-8 bg-rich-gray rounded-xl border border-rich-border shadow-2xl relative overflow-hidden">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        <div>
                            <label htmlFor="name" className="block text-xs font-bold text-gold-400 uppercase tracking-wider mb-2">Nome Completo</label>
                            <input
                                id="name"
                                name="name"
                                type="text"
                        ...
                        <div>
                            <label htmlFor="email" className="block text-xs font-bold text-gold-400 uppercase tracking-wider mb-2">Email</label>
                            <input
                                id="email"
                                name="email"
                                type="email"
                        ...
                        <div>
                            <label htmlFor="role" className="block text-xs font-bold text-gold-400 uppercase tracking-wider mb-2">Tipo de Conta</label>
                            <div className="relative">
                                <select
                                    ...
                                    className="appearance-none block w-full px-4 py-3.5 bg-rich-dark border border-rich-border text-white rounded-lg focus:outline-none focus:border-gold-400 focus:ring-1 focus:ring-gold-400 transition-all sm:text-sm"
                                >
                        ...
                        <div>
                            <label htmlFor="password" className="block text-xs font-bold text-gold-400 uppercase tracking-wider mb-2">Senha</label>
                            <input
                                id="password"
                                name="password"
                                type="password"
                    ...
                    <div className="text-center mt-6">
                        <p className="text-sm text-gray-400">
                            Já é membro?{' '}
                            <Link to="/login" className="font-bold text-gold-400 hover:underline transition-colors uppercase text-xs tracking-wider">
                                Entrar na conta
                            </Link>
                        </p>
                    </div>
